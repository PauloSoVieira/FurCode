    ...
    public SecurityFilterChain securityFilters(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/person").hasAnyAuthority("USER")
                        .requestMatchers(HttpMethod.POST, "/api/v1/person/{id}/create-shelter").hasAnyAuthority("USER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/person/all").hasAnyAuthority("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/person/{id}/add-person-to-shelter").hasAnyAuthority("ADMIN")
