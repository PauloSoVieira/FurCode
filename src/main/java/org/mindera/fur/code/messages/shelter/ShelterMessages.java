...
public class ShelterMessages {
    ...
    public static final String POST_CODE_CANT_BE_EMPTY = "Post Code can't be empty";
    public static final String POST_CODE_CANT_BE_ZERO_OR_LOWER = "Post Code can't be zero or lower";
    public static final String POST_CODE_CANT_BE_NULL = "Post Code can't be null";
